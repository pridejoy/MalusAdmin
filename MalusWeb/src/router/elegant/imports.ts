...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  business_calen: () => import("@/views/business/calen/index.vue"),
  business_config: () => import("@/views/business/config/index.vue"),
  business_customer: () => import("@/views/business/customer/index.vue"),
  business_order: () => import("@/views/business/order/index.vue"),
  business_sales: () => import("@/views/business/sales/index.vue"),
  ...
  syslog_logerr: () => import("@/views/syslog/logerr/index.vue"),
  syslog_logop: () => import("@/views/syslog/logop/index.vue"),
  syslog_logvis: () => import("@/views/syslog/logvis/index.vue"),
  sysmanage_cache: () => import("@/views/sysmanage/cache/index.vue"),
  sysmanage_config: () => import("@/views/sysmanage/config/index.vue"),
  sysmanage_dic: () => import("@/views/sysmanage/dic/index.vue"),
