...
{
    public static T Result<T>(int code = StatusCodes.Status200OK, string? message = ApiResultMessage.Status200OK, T? data = default)
    {
    ...
    /// <returns></returns>
    public static ApiResultException Exception207Bad(string? message = ApiResultMessage.Status400BadRequest, object? data = null)
    {
